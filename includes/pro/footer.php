    ...
    <div class="container">
        <div class="row">
            ...
            <div class="widget col-md-3">
                <div class="about">
                    <h2 class="title">À Propos <span class="border"></span></h2>
                    <p>Vivamus ante nulla, ultrices ut molestie pellentesque, posuere eu ligula. In porttitor in turpis eu porttitor. </p>
                </div>
                <ul class="fa-ul">
                    <li><i class="fa-li fa fa-map-marker"></i>ZAC du Port, 97400 LE PORT <br>La Réunion
                    </li>
                    <li> <i class="fa-li fa fa-phone fa-flip-horizontal"></i>+262 6 62 12 31 23</li>
                    <li><i class="fa-li fa fa-envelope-o "></i><a href="#">info@nordev.com</a></li>
                </ul>
            </div>

            <div class="widget col-md-3">
                <h2 class="title">Articles Récents<span class="border"></span></h2>
