...
<div class="row-fluid">
  ...
  <div class="metro-nav">
    <div class="metro-nav-block nav-block-orange">
      <a data-original-title="" href="index.php?ac=gestion_users">
        <i class="icon-user"></i>
        <div class="info">321</div>
        <div class="status">Nouveaux utilisateurs</div>
      </a>
    </div>
    <div class="metro-nav-block nav-olive">
      <a data-original-title="" href="#">
        ...
        <div class="status">Billets vendus</div>
      </a>
    </div>
    <div class="metro-nav-block nav-block-yellow">
      <a data-original-title="" href="index.php?ac=gestion_events">
        <i class="icon-th"></i>
        <div class="info">49</div>
        <div class="status">Événements</div>
      </a>
    </div>
  ...
  <div class="metro-nav">
    ...
    <div class="metro-nav-block nav-light-brown">
      <a data-original-title="" target="_blank" href="../index.php">
        <i class="icon-external-link"></i>
        <div class="status">Consulter le site</div>
      </a>
    </div>
    <div class="metro-nav-block nav-block-grey ">
      <a data-original-title="" href="index.php?ac=deconnexion">
        <i class="icon-remove-sign"></i>
        <div class="info"></div>
        <div class="status">Se déconnecter</div>
      </a>
    </div>
  </div>
